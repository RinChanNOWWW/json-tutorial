    ...
    switch (src->type) {
        ...
        case LEPT_OBJECT:
            ...
            for (i = 0; i < src->u.o.size; i++) {
                obj_v = lept_set_object_value(dst, src->u.o.m[i].k,
                                              src->u.o.m[i].klen);
                lept_copy(obj_v, &src->u.o.m[i].v);
            }
    ...
    switch (lhs->type) {
        ...
        case LEPT_OBJECT:
            ...
            for (i = 0; i < lhs->u.o.size; i++) {
                if ((j = lept_find_object_index(rhs, lhs->u.o.m[i].k,
                                                lhs->u.o.m[i].klen)) ==
                    LEPT_KEY_NOT_EXIST) {
                    return 0;
                }
                if (lhs->u.o.m[i].klen != rhs->u.o.m[j].klen ||
                    memcmp(lhs->u.o.m[i].k, rhs->u.o.m[j].k,
                           lhs->u.o.m[i].klen) != 0) {
                    return 0;
                }
...
lept_value* lept_insert_array_element(lept_value* v, size_t index) {
    ...
    memcpy(&v->u.a.e[index + 1], &v->u.a.e[index],
           (v->u.a.size - index) * sizeof(lept_value));
...
void lept_shrink_object(lept_value* v) {
    ...
    if (v->u.o.capacity > v->u.o.size) {
        ...
        v->u.o.m = (lept_member*)realloc(v->u.o.m,
                                         v->u.o.capacity * sizeof(lept_value));
    }
}
...
lept_value* lept_set_object_value(lept_value* v, const char* key, size_t klen) {
    ...
    if (i != LEPT_KEY_NOT_EXIST) {
        return &v->u.o.m[i];
    }
    if (v->u.o.size == v->u.o.capacity) {
        lept_reserve_object(v,
                            v->u.o.capacity == 0 ? 1 : (v->u.o.capacity << 1));
    }
    i = v->u.o.size;
...
void lept_remove_object_value(lept_value* v, size_t index) {
    ...
    memcpy(v->u.o.m + index, v->u.o.m + index + 1,
